...
class PlayTime(models.TextChoices):
    MORNING = "morning", "Morning (6–11)"
    AFTERNOON = "afternoon", "Afternoon (11–5)"
    EVENING = "evening", "Evening (5–10)"
...
class Team(models.Model):
    ...
    # Team model — add alongside age_category
    preferred_days = models.JSONField(
        default=list,
        blank=True,
        help_text="List of day codes, e.g. ['mon', 'wed', 'sat']. Not queried at "
                "scale, so JSON is fine here — same rationale as `preferences`.",
    )
