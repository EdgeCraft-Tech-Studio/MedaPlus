/* ============================================================
   MedaPlus — shared icon set
   All icons are stroke-based, inherit color via currentColor,
   and accept standard SVG props (width/height/className/etc.)
   ============================================================ */

export function BallIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
...
export function VersusIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" {...props}>
...
export function HomeIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" {...props}>
      <path d="M3.5 10.5L12 4l8.5 6.5" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M5.5 9.5V19a1 1 0 001 1h4v-5.5h3V20h4a1 1 0 001-1V9.5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function UserCircleIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" {...props}>
      ...
      <path d="M6 18.2c1.2-2.4 3.4-3.7 6-3.7s4.8 1.3 6 3.7" strokeLinecap="round" />
    </svg>
  );
}
...
export function InboxEmptyIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" {...props}>
      <path d="M4 13l2.5-7A2 2 0 018.4 4.5h7.2A2 2 0 0117.5 6l2.5 7" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M4 13h5a1 1 0 011 1 2 2 0 004 0 1 1 0 011-1h5v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5z" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function CrownIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" {...props}>
      <path d="M4 8l3.5 3L12 5l4.5 6L20 8l-1.6 9H5.6L4 8z" strokeLinejoin="round" />
    </svg>
  );
}

export function ShieldSmallIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" {...props}>
      <path d="M12 3l7 3v5.4c0 4.6-3 8.4-7 9.6-4-1.2-7-5-7-9.6V6l7-3z" />
    </svg>
...
export function UserPlusIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" {...props}>
      ...
      <path d="M2.5 20c.8-3.9 3.4-6 6.5-6s5.7 2.1 6.5 6" />
...
export function LinkIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" {...props}>
      ...
      <path d="M11.5 6.5l1.4-1.4a3.5 3.5 0 015 5L16.5 11.5M12.5 17.5l-1.4 1.4a3.5 3.5 0 01-5-5L7.5 12.5" strokeLinecap="round" />
    </svg>
  );
}
...
export function HashIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" {...props}>
      <path d="M5 9h14M5 15h14M10 4L8 20M16 4l-2 16" strokeLinecap="round" />
    </svg>
  );
}
...
export function SettingsIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" {...props}>
      ...
      <path d="M19.4 13a7.6 7.6 0 000-2l2-1.5-2-3.5-2.4 1a7.7 7.7 0 00-1.7-1L15 3h-6l-.3 2.5a7.7 7.7 0 00-1.7 1l-2.4-1-2 3.5L4.6 11a7.6 7.6 0 000 2l-2 1.5 2 3.5 2.4-1a7.7 7.7 0 001.7 1L9 21h6l.3-2.5a7.7 7.7 0 001.7-1l2.4 1 2-3.5-2-1.5z" />
    </svg>
  );
}
