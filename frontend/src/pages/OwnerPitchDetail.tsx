...
function Icon({ name, size = 15 }: { name: IconName; size?: number }) {
  const paths: Record<IconName, React.ReactNode> = {
    ...
    cash: (<><rect x="2.5" y="6" width="19" height="12" rx="2.5" /><circle cx="12" cy="12" r="3" /><path d="M6 9.2v-.01M18 14.8v.01" strokeLinecap="round" /></>),
    calendarCheck: (<><rect x="3" y="4.5" width="18" height="16" rx="2" /><path d="M3 9.5h18" /><path d="M8 3v3M16 3v3" /><path d="m8.5 14.5 2 2 4-4" /></>),
    pin: (<><path d="M12 21s-7-7.58-7-12a7 7 0 0 1 14 0c0 4.42-7 12-7 12z" /><circle cx="12" cy="9" r="2.5" /></>),
    clock: (<><circle cx="12" cy="12" r="9" /><polyline points="12 7 12 12 16 14" /></>),
    tag: (<><path d="M20.59 13.41 12 22 2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82z" /><circle cx="7" cy="7" r="1.4" /></>),
    ...
    car: (<><path d="M3 13l1.2-3.6A2 2 0 0 1 6.1 8h11.8a2 2 0 0 1 1.9 1.4L21 13v5a1 1 0 0 1-1 1h-1a1 1 0 0 1-1-1v-1H6v1a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1z" /><circle cx="7" cy="17" r="1.4" /><circle cx="17" cy="17" r="1.4" /></>),
    bulb: <path d="M9 18h6M10 22h4M12 2a7 7 0 0 0-4 12.7c.6.5 1 1.2 1 2.3h6c0-1.1.4-1.8 1-2.3A7 7 0 0 0 12 2z" />,
    imageOff: (<><rect x="3" y="3" width="18" height="18" rx="2" /><circle cx="8.5" cy="8.5" r="1.4" /><path d="M21 15l-5-5L5 21" /></>),
    pencil: <path d="m14.5 3.5 3 3L7 17l-4 1 1-4 10.5-10.5z" />,
    x: <path d="M18 6 6 18M6 6l12 12" />,
    mail: (<><rect x="3" y="5" width="18" height="14" rx="2" /><path d="M3 7l9 6 9-6" /></>),
    phone: <path d="M6.6 10.8a15 15 0 0 0 6.6 6.6l2.2-2.2a1 1 0 0 1 1-.25 9.5 9.5 0 0 0 3 .48 1 1 0 0 1 1 1V20a1 1 0 0 1-1 1A17 17 0 0 1 3 4a1 1 0 0 1 1-1h3.5a1 1 0 0 1 1 1 9.5 9.5 0 0 0 .48 3 1 1 0 0 1-.25 1l-2.2 2.2z" />,
        ...
        <div className={styles.headRow}>
          <div>
            <div className={styles.titleRow}>
              ...
              <span className={`${styles.sportPill} ${pitch.sport_type === "BASKETBALL" ? styles.sportPillBasketball : styles.sportPillFootball}`}>
                {sportLabel(pitch.sport_type)}
              </span>
              <span className={`${styles.statusPill} ${pitch.is_approved ? styles.statusApproved : styles.statusPending}`}>
